...
function DressColorRecommendation({ onReset }) {
  ...
  const { dress_color_recommendations, category, undertone_info, general_classification, exact_skin_color } =
    analysisResults;
    ...
    return (
      <div className="max-w-4xl mx-auto p-8">
        <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-3xl shadow-xl p-12 text-center">
          ...
          <p className="text-2xl text-gray-600 mb-6">Dress color recommendations are not available.</p>
          <button
            onClick={onReset}
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 p-4">
      ...
      <div className="bg-gradient-to-r from-pink-100 via-purple-100 to-pink-100 p-6 rounded-3xl shadow-lg">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6">
          ...
          <div className="bg-white px-8 py-4 rounded-2xl shadow-md flex items-center gap-4">
            <div
              className="w-20 h-20 rounded-xl border-3 border-gray-300 shadow-md"
      ...
      <div className="flex flex-col md:flex-row gap-4 mt-6 justify-center">
        ...
        {/* TRY-ON WITH STATE FIXED */}
        <button
          onClick={() =>
            navigate("/results/tryon", { state: { userName, results: analysisResults } })
          }
